...
var app = new Vue({
  ...
  methods: {
    getLink: function getLink(name) {
      var list = this.students.filter(function (i) {
        return i.name == name;
      });
    ...
    scrollToView: function scrollToView(id, event) {
      event.preventDefault();
      var nav = '#' + id; // calculate scroll from top value
...
app.$nextTick(function () {
  ...
  */
  document.querySelector('#app').style.display = 'block'; // check for touch screens
